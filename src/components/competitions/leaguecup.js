        ...
        return(
            ...
            <div className="competitions" style={{width: '80%', margin: 'auto'}}>
                ...
                <Grid className="comps">
                    <Cell col={0}></Cell>
                    <Cell col={12}>
                        <p className="competitions"><i class="fas fa-trophy"></i> '@bot fhlc' or '@bot league cup' , '@bot scores' or '@bot live fhlc' <i class="fas fa-trophy"></i></p>
                        <br></br>
                        <p>The Finch Howe League Cup is a rigorous test of consistency over the course of an entire season. Each week, the four teams with the highest score are awarded 3 League Cup Points, the four teams scoring in the middle are awarded 1 League Cup Point, and the four lowest scoring teams get 0 Cup Points.</p>
