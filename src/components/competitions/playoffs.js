        ...
        return(
            ...
            <div className="competitions" style={{width: '80%', margin: 'auto'}}>
                ...
                <Grid className="comps">
                    <Cell col={3}></Cell>
                    <Cell col={6}>
                    <p className="competitions"><i class="fas fa-star"></i> '@bot standings' or '@bot playoffs' <i class="fas fa-star"></i></p>
                    <br></br>
                    <p>We all know the "Playoff Championship" by its traditional name, the "League Championship". However, with the advent of our four major competitions we'll have to become more precise with our diction so as to avoid confusion between competitions. The league playoff winner will now be referred to as the "Playoff Champion".</p>
                ...
                <Grid className="competitions">
                    <Cell col={12}><h5>History of Playoff Champions</h5></Cell>
                </Grid>
                <Grid className="comp-grid">
                    <Cell col={4}>
                        <div className="history">
                            <h5>12-team Modern Era</h5>
                            <h6>2018: Doug</h6>
                            <h6>2017: Doug</h6>
                            <h6>2016: RTRO</h6>
                            <h6>2015: RTRO</h6>
