    ...
    render() {
        return(
            ...
            <div className="competitions" style={{width: '80%', margin: 'auto'}}>
                ...
                <Grid className="comp-grid">
                    <Cell col={0}></Cell>
                    <Cell col={12}><p>Maze's Width Marathon (MWM) is a competition that spans multiple seasons, with a new "Stage" of the "Marathon" occurring each new season. The first franchise to win two Stages wins the Marathon and the accrued prize pool. Think of it as being like the Champions League, but where the winner of our MWM competition must win two individual Champions League titles to win the Marathon.</p>
